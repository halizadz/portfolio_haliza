...
export const portfolioData = {
  profile: {
    ...
    about: 'Mahasiswa semester 5 Informatika yang antusias dengan pengembangan web modern. Aktif dalam organisasi kampus dengan pengalaman kepemimpinan dan kolaborasi tim. Memiliki minat dalam React, Laravel, dan teknologi web terkini.',
  ...
  projects: [
    {
      ...
      description: 'Platform manajemen kantin kampus digital yang menghubungkan penjual, pembeli, dan admin. Dibangun dengan React dan Laravel untuk menyederhanakan proses pemesanan makanan dan transaksi di lingkungan kampus.',
      technologies: ['React', 'Laravel', 'MySQL', 'Tailwind CSS'],
      image: '/kuo.png', // Letakkan gambar di folder public/
    ...
    },
    {
      ...
      description: 'Platform digital untuk mengelola aktivitas Satuan Kredit Partisipasi (SKP) mahasiswa. Menghubungkan mahasiswa, dosen, dan administrasi fakultas dalam satu sistem.',
    ...
    },
    {
      ...
      description: 'Platform kesehatan digital untuk pemesanan dokter online. Menyediakan solusi efisien bagi pasien dan tenaga medis dengan antarmuka yang responsif.',
  ...
  organizations: [
    {
      ...
      period: '2024 - 2025',
      description: 'Memimpin divisi yang menjadi jembatan utama antara organisasi mahasiswa IT dengan berbagai pihak eksternal. Bertanggung jawab mengawasi komunikasi strategis, partnership, dan pengembangan peluang kolaborasi untuk mendukung kegiatan organisasi.',
      achievements: [
    ...
    {
      name: 'HIMTIKA (Himpunan Mahasiswa Informatika UNSIKA)',
      position: 'Anggota Departemen Public & Marketing',
      period: '2023 - 2024',
      description: 'Berperan dalam pengembangan branding dan strategi pendanaan organisasi melalui pendekatan teknologi informasi. Fokus pada pembuatan tools marketing dan penggalangan dana untuk kegiatan fakultas.',
      achievements: [
